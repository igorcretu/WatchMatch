...
Open `http://localhost:8000/docs` — the Swagger UI lets you create a user and verify all endpoints work.
...
The app talks to `http://localhost:8000/api` in dev mode (see `src/environments/environment.ts`).
